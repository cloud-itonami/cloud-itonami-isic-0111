...
**Maturity: `:implemented`** — `src/cerealops/` implements the reference
CerealOpsAdvisor / FieldOperationsGovernor actor as a synchronous stub
...
crop/jurisdiction reference-data expansion in `cerealops.facts`. Open
