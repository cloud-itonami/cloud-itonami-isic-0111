# Operator Quickstart — Cereal-Growing Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0111** (`cloud-itonami-isic-0111`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0111.git
cd cloud-itonami-isic-0111
```
...
- Blueprint governor key: `field-operations-governor`
- Likely source path: `cerealops.governor.cljc`
